      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[#0F172A]">
        ...
        <div className="w-full max-w-[480px] relative z-10 animate-fadeIn">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-4xl font-black text-white tracking-tighter mb-2">Nokta Dashboard</h1>
            <p className="text-slate-400 font-medium">Google Sheet verilerinizi anlık dashboard'a dönüştürün</p>
          </div>
          ...
          <div className="glass-panel rounded-[32px] p-8 shadow-2xl">
            ...
            <div className="mb-8">
              ...
              {isAuthenticated ? (
                ...
                <button
                  onClick={login}
                  disabled={isLoading}
                  className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all shadow-lg shadow-blue-600/30 flex items-center justify-center gap-3 animate-pulse-subtle"
                >
                  <LogIn size={20} />
                  {isLoading ? 'Yükleniyor...' : "DASHBOARD'A GÜVENLİ GİRİŞ"}
                </button>
              )}
            </div>
            ...
            <div className={!isAuthenticated ? 'opacity-40 pointer-events-none' : ''}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-white">Dashboard Kaynak URL'sini Yapıştırın</h3>
              </div>
              ...
              <div className="relative mb-6">
                ...
                <input
                  type="url"
                  placeholder="Dashboard URL'nizi buraya yapıştırın..."
                  value={sheetUrl}
              ...
              >
                {isAnalyzing ? (
                  ...
                  <>
                    <span className="mb-0.5">Dashboard'a Bağlan</span>
              ...
              <div className="flex gap-3 mt-4">
                <button 
                  onClick={handleExampleSheet}
                  className="flex-1 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-400 transition-all"
                >
                  Örnek Sheet Kullan
                </button>
              </div>
