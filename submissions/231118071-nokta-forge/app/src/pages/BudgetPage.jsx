...
export default function BudgetPage() {
  ...
  const handleExportCSV = () => {
    const headers = ['Category', 'Name', ...MONTHS];
    const rows = [
      ...data.revenueItems.map(item => ['Revenue', item.name, ...MONTHS.map(m => item[m.toLowerCase()])]),
      ...data.costItems.map(item => ['Cost', item.name, ...MONTHS.map(m => item[m.toLowerCase()])])
    ];
    ...
    a.href = url;
    a.download = 'budget_simulation.csv';
    a.click();
  };
    ...
    <div style={{ height: '100vh', overflowY: 'auto', background: '#F8FAFC', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <div style={{ width: '1px', height: '20px', background: '#CBD5E1' }} />
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#1E293B', fontSize: '12px', fontWeight: 600, cursor: 'pointer' }} onClick={handleExportCSV}>
      ...
      <div style={{ padding: '40px 60px', maxWidth: '1600px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '40px' }}>
          <div>
            <h1 style={{ fontSize: '32px', fontWeight: 900, color: '#0F172A', letterSpacing: '-0.02em', marginBottom: '8px' }}>DASHBOARD WORKSPACE</h1>
            <p style={{ fontSize: '15px', color: '#64748B', fontWeight: 500 }}>Yıllık kârlılık ve marjlar için canlı senaryo testi.</p>
          </div>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '24px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '32px' }}>
          ...
          <h3 style={{ fontSize: '14px', fontWeight: 800, color: '#1E293B', textTransform: 'uppercase' }}>KÂRLILIK PERFORMANSI</h3>
        </div>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '32px' }}>
          ...
          <h3 style={{ fontSize: '14px', fontWeight: 800, color: '#1E293B', textTransform: 'uppercase' }}>YILLIK TOPLAM KARŞILAŞTIRMASI</h3>
        </div>
      ...
      <div style={{ 
        ...
        <h3 style={{ fontSize: '11px', fontWeight: 800, color: '#64748B', marginBottom: '32px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>GELİR KAYNAĞI DAĞILIMI</h3>
