...
export function AuditOverlay({ screenshotUri, selectedBounds, screenName, reporterId, onSave, onCancel }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {reporterId && (
          <div style={{ color: '#999', fontSize: '12px', marginBottom: '2px' }}>
            Raporlayan: <span style={{ color: '#555', fontWeight: 500 }}>{reporterId}</span>
          </div>
        )}
