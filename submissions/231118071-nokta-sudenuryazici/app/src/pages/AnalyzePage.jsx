...
export default function AnalyzePage() {
  ...
  const [mascotChat, setMascotChat] = useState("Selam! Ben NOVA. Verilerini analiz ettim, tasarımın hazır! Değişiklik istersen buradayım.");
            ...
            <div className="glass-panel rounded-[32px] border-white/10 p-6 flex flex-col h-full sticky top-12">
              ...
              {!expertRequested ? (
                  <button 
                    ...
                    className="w-full mb-6 py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-3 shadow-xl shadow-emerald-600/30 group"
                  >
              ...
              <div className="w-full aspect-square bg-slate-900/50 rounded-3xl border border-white/5 relative overflow-hidden mb-6">
                <div style={{ width: '100%', height: '100%', position: 'relative' }}>
                  <AvatarScene isSpeaking={isListening} />
                </div>
                <div style={{ position: 'absolute', bottom: 10, right: 10, zIndex: 10 }}>
                  <VoiceVisualizer isListening={isListening} setIsListening={setIsListening} />
                </div>
              </div>
      ...
      <div className="w-full max-w-[540px] relative z-10 animate-fadeIn">
        <div className="glass-panel rounded-[40px] p-12 shadow-2xl text-center border-slate-700/30">
          <div className="mb-10">
            ...
            <h1 className="text-4xl font-black text-white tracking-tighter mb-2 bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">Dashboard Studio</h1>
          ...
          {step === 'idle' && (
            <div className="space-y-8">
              ...
              <button onClick={handleAnalyze} className="w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-2xl transition-all shadow-xl shadow-blue-600/20 flex items-center justify-center gap-3 text-lg">
                Analizi Başlat <ArrowRight size={22} className="group-hover:translate-x-1 transition-transform" />
              </button>
            </div>
          )}
