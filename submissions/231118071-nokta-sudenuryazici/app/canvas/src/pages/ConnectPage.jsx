    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[#0F172A]">
      ...
      <div className="w-full max-w-[480px] relative z-10 animate-fadeIn">
        ...
        <div className="flex flex-col items-center mb-10 text-center">
          <div className="w-24 h-24 bg-gradient-to-br from-blue-600 via-indigo-600 to-emerald-600 rounded-3xl flex items-center justify-center shadow-[0_20px_50px_rgba(37,99,235,0.4)] mb-6 relative group hover:scale-105 transition-transform duration-500">
            <LayoutGrid size={40} color="white" className="relative z-10" />
            <div className="absolute -inset-2 bg-gradient-to-r from-blue-500 via-indigo-500 to-emerald-500 rounded-[32px] blur-xl opacity-20 group-hover:opacity-60 transition duration-1000"></div>
          </div>
          
          <h1 className="text-4xl font-black text-white tracking-tighter mb-2">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">DASHBOARD</span>
          </h1>
          <p className="text-gray-400 text-sm font-medium tracking-wider mb-2">
            Hazır Dashboard Üretimi</p>
          <div className="h-1 w-12 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full mt-6 opacity-30"></div>
        </div>
          ...
          <div className={!isAuthenticated ? 'opacity-40 pointer-events-none' : ''}>
            ...
            >
              {isAnalyzing ? (
                ...
                <>
                  ANALİZİ BAŞLAT <ArrowRight size={18} />
                </>
              )}
            </button>
          </div>
